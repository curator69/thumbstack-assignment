...
// const Subscribe = () => {
//   return (
//     <div className="bg-[#FFF2F1] flex items-center justify-between gap-8 px-20 p-20">
//       <div className="flex flex-col gap-[8rem]">
//         <div className="flex flex-col gap-2">
//           <p className="text-[43px] font-bold text-redPrimary">
...
//           <li className="text-2xl font-medium">Save Upto 20%</li>
//           <li className="text-2xl font-medium">
//             From as little as $0.70 a day
//           </li>
//           <li className="text-2xl font-medium">Pause or cancel anytime</li>
